...
`weaver/_weaver.pyi` is generated by [stubloom](https://github.com/folded/stubloom) and committed, so consumers get
types from the wheel without running anything. Regenerate it after changing the Rust surface:
